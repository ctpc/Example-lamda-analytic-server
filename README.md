...
This is a simple example that shows how to deploy an existing [Express](http://expressjs.com/) application for NUCoach modules, with minimal changes, to AWS Lambda.
